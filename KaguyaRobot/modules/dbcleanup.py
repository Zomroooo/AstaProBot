...
import KaguyaRobot.modules.sql.global_bans_sql as gban_sql
import KaguyaRobot.modules.sql.users_sql as user_sql
from KaguyaRobot import DEV_USERS, OWNER_ID, dispatcher
